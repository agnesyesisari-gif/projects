...
class AuthController extends BaseController
{
    ...
    public function processForgotPassword()
    {
        ...
        if ($user) {
            ...
            $this->sendResetPasswordEmail($user['email'], $user['nama_lengkap']);
    ...
    /**
     * Kirim Email Reset Password - DISABLED
     */
    private function sendResetPasswordEmail($email, $nama)
    {
