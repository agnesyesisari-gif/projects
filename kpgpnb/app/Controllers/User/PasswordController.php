...
class PasswordController extends BaseController
{
    ...
    /**
     * Proses Permintaan Reset Password - DISABLED
     */
    public function processForgotPassword()
    {
        return redirect()->to('/password/forgot')->with('success', 
            'Fitur reset password saat ini tidak tersedia.');
    }

    /**
     * Proses Reset Password - DISABLED
     */
    public function processResetPassword()
    {
        return redirect()->to('/login')->with('error', 'Fitur reset password tidak tersedia.');
    }
    ...
    /**
     * Send Reset Password Email - DISABLED
     */
    private function sendResetPasswordEmail($user, $token)
    {
        // Token-based reset disabled
    }
