...
use App\Models\ProkerModel\KomisiModel;
use App\Models\ProkerModel\AnggotaModel;
...
class KomisiController extends ResourceController
{
    use ResponseTrait;
    ...
    public function __construct()
    {
        ...
        $this->anggotaKomisiModel = new AnggotaModel();
        $this->programKerjaModel  = new ProkerModel();
